...
<body class="skin-blue sidebar-collapse sidebar-mini" style="height: auto;">
<!-- Site wrapper -->
<div class="wrapper" style="height: auto;">
    ...
    <div class="content-wrapper" style="min-height: 921px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="show"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Layout</a></li>
                <li class="active">Your Article</li>
            </ol>
        </section>
        ...
        <section class="content">
            <div class="callout callout-info">
                ...
                <p>enjoy the articles you have chosen.</p>
            </div>
            <!-- Default box -->
            <div class="box">
            ...
            @foreach($articles as $article )
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <a href="{{url('update')}}{{'/'.$article->id}}{{'/'.$article->user_id}}"> update  </a>
                        <a href="{{url('/article/delete')}}{{'/'.$article->id}}{{'/'.$article->user_id}}"> delete </a>
                        <a href="{{url('check')}}{{'/'.$article->id}}"> check</a>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                                <i class="fa fa-minus"></i></button>
                            <button type="button" class="btn btn-box-tool" data-widget="remove" data-toggle="tooltip" title="Remove">
