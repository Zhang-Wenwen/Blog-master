...
<div class="wrapper" style="height: auto;">
    ...
    <aside class="main-sidebar">
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 588px;"><section class="sidebar" style="height: 588px; overflow: hidden; width: auto;">
                <!-- Sidebar user panel -->
              ...
              <span class="label label-primary pull-right">4</span>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="./AdminLTE-2.3.11/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
                            <li><a href="./AdminLTE-2.3.11/layout/boxed.html"><i class="fa fa-circle-o"></i> Boxed</a></li>
                            <li class="active"><a href="../layout/fixed.html"><i class="fa fa-circle-o"></i> Fixed</a></li>
                            <li><a href="collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="./AdminLTE-2.3.11/widgets.html">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="./AdminLTE-2.3.11/charts/chartjs.html"><i class="fa fa-circle-o"></i> ChartJS</a></li>
                            <li><a href="./AdminLTE-2.3.11/charts/morris.html"><i class="fa fa-circle-o"></i> Morris</a></li>
                            <li><a href="./AdminLTE-2.3.11/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
                            <li><a href="./AdminLTE-2.3.11/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="./AdminLTE-2.3.11/UI/general.html"><i class="fa fa-circle-o"></i> General</a></li>
                            <li><a href="./AdminLTE-2.3.11/UI/icons.html"><i class="fa fa-circle-o"></i> Icons</a></li>
                            <li><a href="./AdminLTE-2.3.11/UI/buttons.html"><i class="fa fa-circle-o"></i> Buttons</a></li>
                            <li><a href="./AdminLTE-2.3.11/UI/sliders.html"><i class="fa fa-circle-o"></i> Sliders</a></li>
                            <li><a href="./AdminLTE-2.3.11/UI/timeline.html"><i class="fa fa-circle-o"></i> Timeline</a></li>
                            <li><a href="./AdminLTE-2.3.11/UI/modals.html"><i class="fa fa-circle-o"></i> Modals</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="./AdminLTE-2.3.11/forms/general.html"><i class="fa fa-circle-o"></i> General Elements</a></li>
                            <li><a href="./AdminLTE-2.3.11/forms/advanced.html"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
                            <li><a href="./AdminLTE-2.3.11/forms/editors.html"><i class="fa fa-circle-o"></i> Editors</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="./AdminLTE-2.3.11/tables/simple.html"><i class="fa fa-circle-o"></i> Simple tables</a></li>
                            <li><a href="./AdminLTE-2.3.11/tables/data.html"><i class="fa fa-circle-o"></i> Data tables</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="./AdminLTE-2.3.11/calendar.html">
              ...
              <small class="label pull-right bg-blue">17</small>
                    ...
                    <li>
                        <a href="./AdminLTE-2.3.11/mailbox/mailbox.html">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="./AdminLTE-2.3.11/examples/invoice.html"><i class="fa fa-circle-o"></i> Invoice</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/profile.html"><i class="fa fa-circle-o"></i> Profile</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/login.html"><i class="fa fa-circle-o"></i> Login</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/register.html"><i class="fa fa-circle-o"></i> Register</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/404.html"><i class="fa fa-circle-o"></i> 404 Error</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/500.html"><i class="fa fa-circle-o"></i> 500 Error</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/blank.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                            <li><a href="./AdminLTE-2.3.11/examples/pace.html"><i class="fa fa-circle-o"></i> Pace Page</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
            ...
            </section><div class="slimScrollBar" style="background: rgba(0, 0, 0, 0.2); width: 3px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 350.653px;"></div><div class="slimScrollRail" style="width: 3px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        <!-- /.sidebar -->
    </aside>
    ...
    <div class="content-wrapper" style="min-height: 587px;">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="add"><i class="fa fa-dashboard"></i>writing articles</a></li>
                <li><a href="check_me">viewing my articles</a></li>
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    Start creating your amazing articles
                </div>
                <!-- /.box-body -->
        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Author:{{$article->user_name}}</h3>
                    <div class="box-body">
                    </div>
                    <div class="box-tools pull-right">
                        <button type="button" class="btn btn-box-tool" data-widget="collapse" data-toggle="tooltip" title="Collapse">
                ...
                <!-- /.box-body -->
                <a href="{{url('/article/update')}}{{'/'.$article->id}}{{'/'.$article->user_id}}"> update  </a>
            <a href="{{url('/article/delete')}}{{'/'.$article->id}}{{'/'.$article->user_id}}"> delete </a>
    <a href="{{url('/article/check')}}{{'/'.$article->id}}"> check</a>
                ...
                <div class="box-footer">
                    ...
                    @foreach($comments as $comment)
                        @if($comment->content!=null&&$article->id==$comment->article_id)
                            <div>
                                {{$i++}}  楼评论：
                                @if($article->id==$comment->article_id)
                                    {{$comment->content}}
                                    <br>
                                    评论者  {{$comment->comment_name}}
                                    <a href="={{url('comment_delete')}}{{'/'.$article->user_id}}{{'/'.$comment->id}}{{'/'.$comment->comment_id}}">
                                        delete </a>
                                @endif
                            </div>
                        @endif
            ...
            <!-- /.box -->
            <form action="{{url('/comment/add')}}{{'/'.$article->id}}" method="POST">
                {{csrf_field()}}
                <br>
